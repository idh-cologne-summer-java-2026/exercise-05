...
public class MyLinkedList<T> {
	...
	private class ListElement {
		...
		/**
		 * Recursive function get to retrieve an element from the list
		 * 
		 * @param index The index of the element, counted from this one
		 * @return The payload value of the element
		 */
		T get(int index) {
	 ...
	 */
	public T get_iterative(int index) {
	...
	public T get_recursive(int index) {
		// special case if list is empty
		if (first == null)
			return null;

		// if not special case, we enter the recursion
		return first.get(index);
	}

	public T get(int index) {
		return get_recursive(index);
	}
